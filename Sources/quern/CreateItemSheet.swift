...
struct CreateItemSheet: View {
    ...
    private var createSheetTint: QuernSheetTint {
        switch kind {
        ...
        VStack(alignment: .leading, spacing: 0) {
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 22) {
                    ...
                    QuernLabeledField(label: folderSelection.isEmpty ? "Folder · Unfiled" : "Folder · \(folderSelection)") {
